...
static const _EncoderReadings_type_support_symbol_names_t _EncoderReadings_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rto_msgs, msg, EncoderReadings)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rto_msgs, msg, EncoderReadings)),
  }
};
...
{
  return &::rto_msgs::msg::rosidl_typesupport_cpp::EncoderReadings_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rto_msgs, msg, EncoderReadings)() {
  return get_message_type_support_handle<rto_msgs::msg::EncoderReadings>();
}
