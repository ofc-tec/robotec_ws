...
#include "rto_msgs/msg/detail/gripper_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rto_msgs::msg::GripperState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rto_msgs::msg::GripperState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rto_msgs::msg::GripperState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rto_msgs::msg::GripperState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rto_msgs::msg::GripperState *>(
    untyped_ros_message);
...
{
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rto_msgs, msg, GripperState)() {
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_GripperState__handle;
}
