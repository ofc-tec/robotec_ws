...
#include "rto_msgs/msg/detail/motor_error_readings__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rto_msgs::msg::MotorErrorReadings & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rto_msgs::msg::MotorErrorReadings & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: error_status
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.error_status[0]);
  ...
  // Member: error_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.error_msg[index].size() + 1);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rto_msgs
max_serialized_size_MotorErrorReadings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rto_msgs::msg::MotorErrorReadings;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rto_msgs
max_serialized_size_key_MotorErrorReadings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rto_msgs::msg::MotorErrorReadings *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rto_msgs::msg::MotorErrorReadings *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotorErrorReadings__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rto_msgs::msg::MotorErrorReadings *>(
...
static size_t _MotorErrorReadings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotorErrorReadings(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotorErrorReadings__callbacks = {
  "rto_msgs::msg",
  "MotorErrorReadings",
...
static rosidl_message_type_support_t _MotorErrorReadings__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotorErrorReadings__callbacks,
...
{
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_MotorErrorReadings__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rto_msgs, msg, MotorErrorReadings)() {
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_MotorErrorReadings__handle;
}
