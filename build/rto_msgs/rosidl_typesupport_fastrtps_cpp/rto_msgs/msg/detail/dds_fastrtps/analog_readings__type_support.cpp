...
#include "rto_msgs/msg/detail/analog_readings__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rto_msgs::msg::AnalogReadings & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rto_msgs::msg::AnalogReadings & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rto_msgs
max_serialized_size_AnalogReadings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rto_msgs::msg::AnalogReadings;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rto_msgs
max_serialized_size_key_AnalogReadings(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const rto_msgs::msg::AnalogReadings *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rto_msgs::msg::AnalogReadings *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AnalogReadings__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rto_msgs::msg::AnalogReadings *>(
...
static size_t _AnalogReadings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AnalogReadings(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AnalogReadings__callbacks = {
  "rto_msgs::msg",
  "AnalogReadings",
...
static rosidl_message_type_support_t _AnalogReadings__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AnalogReadings__callbacks,
...
{
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_AnalogReadings__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rto_msgs, msg, AnalogReadings)() {
  return &rto_msgs::msg::typesupport_fastrtps_cpp::_AnalogReadings__handle;
}
