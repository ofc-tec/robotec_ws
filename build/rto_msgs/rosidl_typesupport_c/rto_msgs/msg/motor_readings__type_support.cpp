...
static const _MotorReadings_type_support_symbol_names_t _MotorReadings_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rto_msgs, msg, MotorReadings)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rto_msgs, msg, MotorReadings)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rto_msgs, msg, MotorReadings)() {
  return &::rto_msgs::msg::rosidl_typesupport_c::MotorReadings_message_type_support_handle;
}
