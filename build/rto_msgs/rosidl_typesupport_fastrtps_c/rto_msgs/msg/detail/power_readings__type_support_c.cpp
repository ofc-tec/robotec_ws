...
#include "rto_msgs/msg/detail/power_readings__rosidl_typesupport_fastrtps_c.h"
...
using _PowerReadings__ros_msg_type = rto_msgs__msg__PowerReadings;
...
size_t get_serialized_size_rto_msgs__msg__PowerReadings(
  ...
  size_t current_alignment)
{
  const _PowerReadings__ros_msg_type * ros_message = static_cast<const _PowerReadings__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rto_msgs__msg__PowerReadings;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rto_msgs__msg__PowerReadings * ros_message = static_cast<const rto_msgs__msg__PowerReadings *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rto_msgs__msg__PowerReadings(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rto_msgs__msg__PowerReadings * ros_message = static_cast<rto_msgs__msg__PowerReadings *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rto_msgs__msg__PowerReadings(cdr, ros_message);
}

static uint32_t _PowerReadings__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rto_msgs__msg__PowerReadings(
...
static size_t _PowerReadings__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rto_msgs__msg__PowerReadings(
...
static message_type_support_callbacks_t __callbacks_PowerReadings = {
  "rto_msgs::msg",
  "PowerReadings",
...
static rosidl_message_type_support_t _PowerReadings__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PowerReadings,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rto_msgs, msg, PowerReadings)() {
  return &_PowerReadings__type_support;
}
